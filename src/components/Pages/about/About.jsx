      ...
      <div class="parts_container">
        <div class="experience gradient-border">
          <div>
            ...
            <p>
              A Multidisciplinary Digital Designer based in Iraq. Specialized in
              both, UX & UI Design, in addition to Development skills. From
              Concept to implementation, I make sure the projects are strong
              conceptually and visually appealing and assures the development
              feasibility, also I do that for the love of creating & improving{" "}
            </p>
          </div>

          <div className="gradient-border  shadow-pop-bl section_name">
            <a href="https://drive.google.com/file/d/11jjiT0xlo5KwxOWj8pU5E2znwwvUy2NF/view?usp=sharing" target=" ">
              <h3>Resume</h3>
            </a>
          </div>
        </div>
        ...
        <div class="time_line gradient-border">
          <div className="time_stamp">
            ...
            <p className="details">
              A web developer who works for fun and mostly for myself
            </p>
          </div>
          ...
          <div className="time_stamp">
            ...
            <p className="details">
              At that time I worked with many languages Python, C++, Dart,
              JavaScript, joined the computer science major, artificial
          ...
          <div className="time_stamp">
            ...
            <p className="details">
              tried the field of design, had some courses from Google in UX
              design and finally came to be a full stack developer.
            </p>
          </div>
        </div>
      </div>
